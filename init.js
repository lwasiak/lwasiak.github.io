...
function initShaders() {
    ...
    shaderGrassProgram.lightingDirectionUniform = gl.getUniformLocation(shaderGrassProgram, "uPointLightLocation");
    shaderGrassProgram.directionalColorUniform = gl.getUniformLocation(shaderGrassProgram, "uPointLightColor");
...
//----------------------------------------------------
    ...
    shaderGroundProgram.lightingDirectionUniform = gl.getUniformLocation(shaderGroundProgram, "uPointLightLocation");
    shaderGroundProgram.directionalColorUniform = gl.getUniformLocation(shaderGroundProgram, "uPointLightColor");
...
//----------------------------------------------------
    ...
    shaderTreeProgram.lightingDirectionUniform = gl.getUniformLocation(shaderTreeProgram, "uPointLightLocation");
    shaderTreeProgram.directionalColorUniform = gl.getUniformLocation(shaderTreeProgram, "uPointLightColor");
